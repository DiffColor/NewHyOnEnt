...
import kr.co.turtlelab.andowsignage.tools.Scale;

public class ScalingView extends RelativeLayout {
	int baseWidth;
	int baseHeight;
	...
	public ScalingView(Context context, AttributeSet attributes) {
