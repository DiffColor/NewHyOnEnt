...
namespace TurtleTools
{
    ...
    {
        //public void Maximize(MainWindow targetWindow)
        //{
        //    if (!IsMaximized)
        //    {
        //        IsMaximized = true;
        ...
        //public void Save(MainWindow targetWindow)
        //{
        //    state = targetWindow.WindowState;
        //    style = targetWindow.WindowStyle;
        //    topmost = targetWindow.Topmost;
        //}

        //public void Restore(MainWindow targetWindow)
        //{
        //    targetWindow.WindowState = state;
        //    targetWindow.WindowStyle = style;
        //    targetWindow.Topmost = topmost;
        //    IsMaximized = (state == WindowState.Maximized) ? true:false;
        //}
        ...
        public static void WaitNonBlocking(int seconds)
        {
            if (seconds < 1) return;
