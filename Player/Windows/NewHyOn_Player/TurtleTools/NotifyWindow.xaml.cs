...
namespace TurtleTools
{
    ...
    {
        public NotifyWindow(string msg, Window window = null)
        {
            InitializeComponent();
            if(window != null)
                this.Owner = window;
        ...
        public NotifyWindow(string msg, string btn1, Window window = null)
        {
            InitializeComponent();
            if (window != null)
                this.Owner = window;
        ...
        public NotifyWindow(string msg, string btn1, string btn2, Window window = null)
        {
            InitializeComponent();
            if (window != null)
                this.Owner = window;
