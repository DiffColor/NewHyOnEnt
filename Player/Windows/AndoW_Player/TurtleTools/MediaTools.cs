...
namespace TurtleTools
{
    class MediaTools
    {
        ...
        public static BitmapSource FixedSizeBitmapSource(BitmapSource source, int Width, int Height)
        {
            double sourceWidth = source.PixelWidth;
            double sourceHeight = source.PixelHeight;

            double nPercentW = (double)Width / sourceWidth;
            double nPercentH = (double)Height / sourceHeight;
            double scale = Math.Min(nPercentW, nPercentH);
            ...
            group.Children.Add(new ImageDrawing(source, new Rect(offsetX, offsetY, scaledWidth, scaledHeight)));
