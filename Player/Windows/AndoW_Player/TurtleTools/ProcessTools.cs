...
namespace TurtleTools
{
    public class ProcessTools
    {
        ...
        public static void CloseExeWindow(string processName)
        {
            try
            {
                Process[] procs = Process.GetProcesses();
        ...
        public static Process LaunchProcess(string exePath, string arg = "", bool isAdmin = false, bool useShell = true, bool waitForExit = false, int waitmills = 1000)
        {
            try
            {
        ...
        public static bool IsProcessActivated(int proc_id)
        {
