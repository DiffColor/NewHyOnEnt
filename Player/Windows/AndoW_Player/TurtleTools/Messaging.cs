...
namespace TurtleTools
{
    ...
    public class Messaging
	{
		...
		private static extern uint SendInput(uint nInputs, ref K_INPUT pInputs, int cbSize);
        ...
        [DllImport("user32.dll")]
        internal static extern uint SendInput(uint nInputs, [MarshalAs(UnmanagedType.LPArray), In] M_INPUT[] pInputs, int cbSize);

        public struct M_INPUT
        {
            public UInt32 Type;
		...
		public enum VKeys
		{
            ...
            KEY_HANGUEL = 0x15, //HANGUEL key
            KEY_HANJA = 0x19, //HANJA key
        ...
        public static void MouseClick(Point pt)
        {
            ...
            var inputMouseDown = new TurtleTools.Messaging.M_INPUT();
            inputMouseDown.Type = 0; /// input type mouse
            inputMouseDown.Data.Mouse.Flags = 0x0002; /// left button down

            var inputMouseUp = new TurtleTools.Messaging.M_INPUT();
            inputMouseUp.Type = 0; /// input type mouse
            inputMouseUp.Data.Mouse.Flags = 0x0004; /// left button up

            var inputs = new TurtleTools.Messaging.M_INPUT[] { inputMouseDown, inputMouseUp };

            SendInput((uint)inputs.Length, inputs, Marshal.SizeOf(typeof(TurtleTools.Messaging.M_INPUT)));
		...
		public static bool ForegroundKeyDown(Key key)
		{
			...
			intReturn = SendInput(1, ref structInput, Marshal.SizeOf(new K_INPUT()));
		...
		public static bool ForegroundKeyUp(Key key)
		{
			...
			intReturn = SendInput(1, ref structInput, Marshal.SizeOf(typeof (K_INPUT)));
			return true;
		}
		...
		public static bool SendMessageAll(IntPtr hWnd, Key key, bool alt, bool ctrl, bool shift, int delay = 100)
		{
			CheckKeyShiftState();
			uint intReturn;
			K_INPUT structInput = new K_INPUT {type = INPUT_KEYBOARD, ki = {wScan = 0, time = 0, dwFlags = 0}};
