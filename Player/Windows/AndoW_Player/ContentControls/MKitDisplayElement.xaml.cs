...
{
    /// <summary>
    /// Interaction logic for MKitDisplayElement.xaml
    /// </summary>
    public partial class MKitDisplayElement : UserControl
    {
        ...
        public MKitDisplayElement()
        {
            InitializeComponent();
        }

        public MKitDisplayElement(MainWindow main)
        {
            InitializeComponent();
            parentPage = main;

            SizeChanged += MKitDisplayElement_SizeChanged;
        }

        void MKitDisplayElement_SizeChanged(object sender, SizeChangedEventArgs e)
        {            
        ...
        public void DisplayVideo(string contentPath)
        {
            try
            {
                ...
                DisplayElement.Source = new Uri(contentPath, UriKind.Absolute);
                DisplayElement.Play();
            }
            catch (Exception e)
            {
