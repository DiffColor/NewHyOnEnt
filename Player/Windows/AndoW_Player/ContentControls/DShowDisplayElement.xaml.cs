...
namespace HyOnPlayer
{
    ...
    /// </summary>
    public partial class DShowDisplayElement : UserControl
    {
        ...
        public DShowDisplayElement()
        {
            InitializeComponent();
        }

        public DShowDisplayElement(MainWindow main)
        {
            InitializeComponent();
            parentPage = main;

            SizeChanged += DShowDisplayElement_SizeChanged;
        }

        void DShowDisplayElement_SizeChanged(object sender, SizeChangedEventArgs e)
        {            
        ...
        public void DisplayVideo(string contentPath)
        {
            try
            {
                DisplayElement.Visibility = Visibility.Visible;

                DisplayElement.TransformX = g_TransformX;
                DisplayElement.TransformY = g_TransformY;
                DisplayElement.SourcePath = contentPath;
            }
            catch (Exception e)
            {
            }
        ...
        public void StopVisibleContents()
        {
            this.Dispatcher.Invoke(DispatcherPriority.Normal, (Action)(() =>
            {
                switch (prevType)
                {
                    ...
                    case ContentType.Video:
                        DisplayElement.CloseAndRelease();
                        DisplayElement.SourcePath = string.Empty;
                        DisplayElement.Visibility = Visibility.Hidden;
                        break;

                    case ContentType.Flash:
                    case ContentType.WebBrowserElement:
                        WebBrowserElement.Navigate(new Uri("about:blank"));
        ...
        {
            WebBrowserElement.Visibility = Visibility.Visible;
            ...
            WebBrowserElement.NavigateToString(htmlCode);
        }
