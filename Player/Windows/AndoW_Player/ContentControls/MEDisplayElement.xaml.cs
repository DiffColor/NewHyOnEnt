...
{
    /// <summary>
    /// Interaction logic for MEDisplayElement.xaml
    /// </summary>
    public partial class MEDisplayElement : UserControl
    {
        ...
        public MEDisplayElement()
        {
            InitializeComponent();
        }

        public MEDisplayElement(MainWindow main)
        {
            InitializeComponent();
            parentPage = main;

            SizeChanged += MEDisplayElement_SizeChanged;
        }

        void MEDisplayElement_SizeChanged(object sender, SizeChangedEventArgs e)
        {            
